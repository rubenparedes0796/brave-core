...
#ifndef BRAVE_VENDOR_BAT_NATIVE_LEDGER_SRC_BAT_LEDGER_INTERNAL_CONTRIBUTION_CONTRIBUTION_TOKEN_MANAGER_H_
#define BRAVE_VENDOR_BAT_NATIVE_LEDGER_SRC_BAT_LEDGER_INTERNAL_CONTRIBUTION_CONTRIBUTION_TOKEN_MANAGER_H_
...
class ContributionTokenManager : public BATLedgerContext::Object {
 public:
  ...
  // TODO(zenparsing): Wallet balance routine should now use this.
...
#endif  // BRAVE_VENDOR_BAT_NATIVE_LEDGER_SRC_BAT_LEDGER_INTERNAL_CONTRIBUTION_CONTRIBUTION_TOKEN_MANAGER_H_
